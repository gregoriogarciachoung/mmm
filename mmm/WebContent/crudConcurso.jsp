...
<body>
	...
	<div class="container">
		...
		<div class="col-md-23">
			...
			<form accept-charset="UTF-8" action="consultaConcurso"
										...
										<tr>
											...
											<td>
												<button type='button' data-toggle='modal'
													onclick="editar('${x.idConcurso}','${x.nombre}','${x.fechaInicio}','${x.fechaFin}','${x.estado}');"
				...
				<div class="modal-content">
					...
					<div class="modal-body" style="padding: 20px 10px;">
						<form id="defaultForm" accept-charset="UTF-8"
							action="registraConcurso" class="form-horizontal" method="post">
									...
									<div class="panel-heading">
										<h4 class="panel-title">
											<a data-toggle="collapse" data-parent="#steps"
												href="#stepOne">Datos del Concurso</a>
										</h4>
									</div>
									<div id="stepOne" class="panel-collapse collapse in">
										<div class="panel-body">
											<div class="form-group">
												...
												<div class="col-lg-5">
													<input class="form-control" id="id_reg_nombre"
														name="concurso.nombre" placeholder="Ingrese el Nombre"
														type="text" maxlength="20" />
												</div>
											</div>
											<div class="form-group">
												<label class="col-lg-3 control-label"
													for="id_reg_fechaInicio">Fecha de inicio</label>
												<div class="col-lg-5">
													<input class="form-control" id="id_reg_fechaInicio"
														name="concurso.fechaInicio"
														placeholder="Ingrese la fecha de inicio" type="text"
														maxlength="10" />
												</div>
											</div>
											<div class="form-group">
												<label class="col-lg-3 control-label" for="id_reg_fechaFin">Fecha
													de fin</label>
												<div class="col-lg-5">
													<input class="form-control" id="id_reg_fechaFin"
														name="concurso.fechaFin"
														placeholder="Ingrese la fecha de inicio" type="text"
														maxlength="10" />
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-lg-5">
													<select id="id_reg_estado" name="concurso.estado"
														class='form-control'>
		...
		<div class="modal fade" id="idModalActualiza">
			<div class="modal-dialog" style="width: 60%">
				...
				<div class="modal-content">
					...
					<div class="modal-body" style="padding: 20px 10px;">
						<form id="defaultForm" accept-charset="UTF-8"
							action="actualizaConcurso" class="form-horizontal" method="post">
							<div class="panel-group" id="steps">
								<!-- Step 1 -->
								<div class="panel panel-default">
									<div class="panel-heading">
									...
									<div id="stepOne" class="panel-collapse collapse in">
										<div class="panel-body">
											<div class="form-group">
												...
												<div class="col-lg-5">
													<input class="form-control" id="id_ID" readonly="readonly"
														name="concurso.idConcurso" type="text" maxlength="8" />
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												<label class="col-lg-3 control-label" for="id_fechaInicio">Fecha
													de inicio</label>
												<div class="col-lg-5">
													<input class="form-control" id="id_fechaInicio"
														name="concurso.fechaInicio"
														placeholder="Ingrese la fecha de inicio" type="text"
														maxlength="10" />
												</div>
											...
											<div class="form-group">
												<label class="col-lg-3 control-label" for="id_fechaFin">Fecha
													de fin</label>
												<div class="col-lg-5">
													<input class="form-control" id="id_fechaFin"
														name="concurso.fechaFin"
														placeholder="Ingrese la fecha de inicio" type="text"
														maxlength="10" />
												</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-5">
													<select id="id_estado" name="concurso.estado"
														class='form-control'>
														<option value="">[SELECCIONE]</option>
														<option value="Activo">ACTIVO</option>
														<option value="Inactivo">INACTIVO</option>
